...
All notable changes to @experimental/nuclio will be documented in this file.
...
- Declared external command requirements: bspc, curl
...
- Package naming now includes collection scope: `@experimental/nuclio`
