# nuclio - AI Assistant Instructions

**Package**: `@experimental/nuclio`
**Version**: 0.1.0
**Type**: experimental package

## Package Overview

**Description**: Nuclio Functions - Serverless function platform

**Purpose**: Provide nuclio functions - serverless function platform functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/nuclio` - Main executable
- `.local/bin/nuclio.phase4.backup` - Main executable
...
1. **Test installation**: `stow nuclio`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D nuclio`
